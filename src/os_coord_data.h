...
// Airy 1830
const PROGMEM os_ellipsoid_t OS_EL_AIRY_1830 = {.a=6377563.396, .b=6356256.910};

// GRS80 (aka WGS84 ellipsoid)
const PROGMEM os_ellipsoid_t OS_EL_WGS84 = {.a=6378137.000, .b=6356752.3141};
...
const PROGMEM os_helmert_t OS_HE_WGS84_TO_OSGB36 = {
...
const PROGMEM os_tm_projection_t OS_TM_NATIONAL_GRID = {
...
const PROGMEM os_grid_t OS_GR_NATIONAL_GRID = {
	.num_digits=2,
